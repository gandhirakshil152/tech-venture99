...
import { Code2, Palette, Smartphone, Server, Brain, Blocks, Terminal } from "lucide-react";

const skills = [
  { name: "React", icon: Code2, color: "from-[hsl(195,100%,50%)] to-[hsl(210,100%,60%)]", shadow: "hsl(195,100%,50%)", level: 85 },
  { name: "Tailwind CSS", icon: Palette, color: "from-[hsl(183,100%,40%)] to-[hsl(170,100%,50%)]", shadow: "hsl(183,100%,50%)", level: 90 },
  { name: "JavaScript", icon: Terminal, color: "from-[hsl(50,100%,50%)] to-[hsl(40,100%,55%)]", shadow: "hsl(50,100%,50%)", level: 80 },
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-accent font-semibold text-foreground text-sm tracking-wider">{skill.name}</h3>
